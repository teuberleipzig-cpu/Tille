...
test('changed active entry points and secondary loaders carry staging cache versions', async () => {
  ...
  for (const name of ['staging-admin', 'admin-app', 'github-media', 'events-meta', 'auto-github-load', 'admin-v2-current-fixes']) assert.ok(html.includes(name + '.js?v=admin-staging-1'));
