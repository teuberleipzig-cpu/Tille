...
const rules = [
  ...
  { id: 'event-meta', classification: 'MUTABLE', exact: 'public/events/data/meta.json', owners: ['public/site/js/event-storage-model.js'] },
  ...
  { id: 'residents', classification: 'MUTABLE', exact: 'public/residents/data/residents.json', owners: ['public/admin/js/auto-github-load.js', 'public/admin/js/features/residents/residents-news-csv-save.js', 'public/resident-portal/js/core/github.js'] },
  ...
  { id: 'gallery', classification: 'MUTABLE', exact: 'public/gallery/data/gallery.json', owners: ['public/admin/js/features/gallery/gallery.js', 'public/admin/js/features/gallery/gallery-save.js'] },
